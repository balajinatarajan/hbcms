...
CODE Updated: 2012-Jan-26 
Manual Update Version: H.24.1.m7
Manual Update Date: 2013-Jun-11
File Size: 45034 bytes*/
/************************ ADDITIONAL FEATURES ************************
     Universal Tag
     Plugins
*/
...
s.linkInternalFilters="javascript:,.siriusxm.com"
s.linkLeaveQueryString=false
s.linkTrackVars="prop6,prop7,prop8,prop9";

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
s.visitorNamespace="siriusxm"
s.trackingServer="metrics.siriusxm.com"
s.trackingServerSecure="smetrics.siriusxm.com"

s.doSetupLinkTrack = true;

/* Plugin Config */
s.usePlugins=true
function s_doPlugins(s) {
	
	/* Set Up Link Track 2.0 */
		s.hbx_lt = "auto" // manual, auto
		if(s.doSetupLinkTrack){
			s.manageVars('clearVars', "prop6,prop7,prop8,prop9,eVar5,eVar6,eVar7,eVar8,eVar14,eVar15", 1);
			s.setupLinkTrack("prop6,prop7,prop8,prop9","SC_LINKS");
		}
	...
	/* Get Days Since Last Visit */
		s.prop23=s.getDaysSinceLastVisit('s_dayslastvisit');
		s.eVar23="D=c23";
	...
	/* External Campaign Tracking */
		...
		s.eVar26 = s.getQueryParam('utm_source'); //source
		s.eVar27 = s.getQueryParam('utm_medium'); //medium
		
	/* Ignition One Tracking */
		s.eVar33 = s.getQueryParam('IgnitionOne'); 

	/* PageName copy to eVar */
		s.eVar10="D=pageName";
...
+"0&&oc.indexOf('return false')<0){s.c_w(c,cv,0);}else return ''");
